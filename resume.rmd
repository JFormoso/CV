...
```{r}
if(params$pdf_mode){
  cat("View this resume online with links at _jformoso.github.io/cv/resume/_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https:///github.com/jformoso/cv/raw/master/formoso_resume.pdf)")
}
```


For a longer form version, see my [CV](jformoso.github.io/cv/).
